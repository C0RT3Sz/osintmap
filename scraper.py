...
# Coleta de Links Externos e Internos
...
# Exploração de Páginas Internas e Coleta de Títulos
print("\nExplorando páginas internas e coletando títulos...\n")

for link in links_internos:
    try:
        resposta_pagina = requests.get(link, headers=headers, timeout=5)
        ...
        print(f"Error ao acessar {link}: {e}")
